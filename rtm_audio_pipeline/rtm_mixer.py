...
- Apply bg_vol ONCE (pre-duck), not pre + post.
- Remove dynaudnorm.
- Move loudnorm to FINAL step (after the outro crossfade) so bg_vol remains audible.
- Log filter graphs verbosely for debugging.
"""
...
def main():
    ...
    # Mix controls
    ap.add_argument("--bg_vol", type=float, default=0.25, help="BG volume multiplier (applied pre-duck)")
